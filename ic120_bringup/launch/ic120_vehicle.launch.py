...
def generate_launch_description():
    ...
    ic120_handler_launch_file_path=os.path.join(ic120_handler_dir,'launch',"ic120_handler.launch.py")
    g2_ros_launch_file_path=os.path.join(g2_ros_dir,'launch',"g2_ros.launch.py")
    ic120_joint_publisher_launch_file_path=os.path.join(ic120_joint_publisher_dir,'launch',"ic120_joint_publisher.launch.py")
