...
def generate_launch_description():
    ...
    launch_dir = os.path.join(ic120_unity_dir, 'launch')
    ic120_description_dir=get_package_share_directory("ic120_description")

    map_yaml_file=os.path.join(ic120_navigation_dir, 'map', 'map.yaml')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(ic120_navigation_dir, 'params', 'navigation_parameters_3.yaml'),
